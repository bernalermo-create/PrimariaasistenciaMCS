...
## ⚠️ IMPORTANTE — revisa el horario de las jornadas antes de usarlo

Como no conozco el horario real de Primaria en tu colegio, puse una hora
típica de colegio de doble jornada, **a manera de punto de partida**:
...
**Si estas horas no son las reales**, dime los horarios correctos y te
actualizo los dos archivos — es un cambio rápido. Mientras tanto, la app
funciona igual, solo que el bloque "sugerido automáticamente" y el aviso
de "ya pasó la hora" se guiarían por estas horas de ejemplo.
